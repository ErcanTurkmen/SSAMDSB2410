...
import OperationMobileStatusHelper from '../../../SAPAssetManager/Rules/Operations/MobileStatus/OperationMobileStatusHelper';
import SubOperationMobileStatusHelper from '../../../SAPAssetManager/Rules/SubOperations/MobileStatus/SubOperationMobileStatusHelper';
import WorkOrderMobileStatusHelper from '../../../SAPAssetManager/Rules/WorkOrders/MobileStatus/WorkOrderMobileStatusHelper';
...
import ZOperationConfirmVisible from '../WorkOrders/Operations/ZOperationConfirmVisible';
import ZOperationCompleteVisible from '../WorkOrders/Operations/ZOperationCompleteVisible';
import ZOperationStartVisible from '../WorkOrders/Operations/ZOperationStartVisible';
...
export default class MobileStatusGenerator {
    ...
    _getTransferStatusOverrideProperties() {
        return {
            ...this._getGenericStatusOverrideProperties(),
            Visible: false,         //this._helperClass.isTransferStatusVisible(), //DSB customization to remove transfer
    ...
    async _getStartedStatusOverrideProperties() {
        ...
        return {
            ...this._getGenericStatusOverrideProperties(),
            Visible: !isAnythingStarted && ZOperationStartVisible(this._binding),
    ...
    _getCompletedStatusOverrideProperties() {
        return {
            ...this._getGenericStatusOverrideProperties(),
            Visible: ZOperationCompleteVisible(this._binding),  //this._helperClass.isCompletedStatusVisible(), //DSB enhancement for complete status enable
    ...
    async _getConfirmStatusOverrideProperties() {
        ...
        const isOperationHeaderLevelAssignment = ['Header', 'Operation'].includes(libCom.getWorkOrderAssnTypeLevel(this._context));
        if (isOperationHeaderLevelAssignment && currentMobileStatus !== this._COMPLETED) {
            OnlyOption = true;
