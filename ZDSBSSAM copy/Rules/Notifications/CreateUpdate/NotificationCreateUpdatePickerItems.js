...
export default function NotificationCreateUpdatePickerItems(context) {
    ...
    if (onCreate) {
        ...
        formCellContainer.getControl('EquipHierarchyExtensionControl').setEditable(false);
        formCellContainer.getControl('FuncLocHierarchyExtensionControl').setEditable(false);
    }
}
