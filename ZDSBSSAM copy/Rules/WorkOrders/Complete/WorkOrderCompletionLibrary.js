        ...
        for (const name of names) {
            ...
            switch (name) {
                ...
                case 'time': {
                    ...
                    steps[name].visible = false; //DSB customization to skip timebookinglibSuper.isSupervisorFeatureEnabled(context) && isSupervisor ? libSuper.isSupervisorTimeEnabled(context) : true; 
                    steps[name].lam = '';
                    break;
                }
                case 'note': {
                    steps[name].visible = false; //DSB customization to directly complete operations  libSuper.checkReviewRequired(context, context.binding);
                    break;
                }
