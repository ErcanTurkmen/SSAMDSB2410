...
import phaseFilterResult from '../../../../SAPAssetManager/Rules/PhaseModel/PhaseModelFilterPickerResult';
...
export function GetWorkOrderOperationListFilterCriteria(context, saveToClientData = false) {
    let filterResults = [
        ...
        //DSB customisation for user role filter
	    context.evaluateTargetPath('#Page:WorkOrderOperationsFilterPage/#Control:UserRoleFilter/#FilterValue'),
    ];
