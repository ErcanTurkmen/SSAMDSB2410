...
export function getNotificationMenuItems() {
    return [
        ...
        //DSB customisation to add activity
        {
            '_Name': 'Add_Activity',
            'Image': '$(PLT, /SAPAssetManager/Images/additem.png, /SAPAssetManager/Images/additem.android.png)',
            'Text': '$(L,add_activity)',
            'Mode': 'Normal',
            'OnSwipe': '/SAPAssetManager/Rules/Notifications/Activity/CreateUpdate/NotificationActivityCreateNav.js',
        },
        //
    ];
}
...
export async function getOperationMenuItems(context) {
    ...
    return [
        ...
        },
        {
            ...
            'Image': '$(PLT, /SAPAssetManager/Images/addnotif.png, /SAPAssetManager/Images/addnotif.android.png)',
            'Text': '$(L,zPRTAddEquipment)',
            'Mode': 'Normal',
            'OnSwipe': '/ZDSBSSAM/Rules/WorkOrders/Operations/PRT/ZPRTEquipmentAddNavFromSwipe.js',
        },
        ...statusMenuItems,
    ];
}
