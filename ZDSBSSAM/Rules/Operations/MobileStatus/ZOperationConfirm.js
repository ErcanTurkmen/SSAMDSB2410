...
export default function ZOperationConfirm(context) {
    ...
    if (context.constructor.name === 'ObjectCardActionItemProxy' || context.constructor.name ==='ObjectCellContextMenuItemProxy' || context.constructor.name ==='SectionedTableProxy') {
