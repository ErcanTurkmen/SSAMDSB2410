...
export default function NotificationCreateUpdateValidation(pageClientAPI) {
    ...
    //if (onCreate) {
    let floc = formCellContainer.getControl('FuncLocHierarchyExtensionControl').getValue() || pageClientAPI.binding.HeaderFlocId;
    var equipment = formCellContainer.getControl('EquipHierarchyExtensionControl').getValue() || pageClientAPI.binding.HeaderEquipment;
