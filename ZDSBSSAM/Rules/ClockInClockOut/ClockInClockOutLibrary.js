...
import libThis from '../../../SAPAssetManager/Rules/ClockInClockOut/ClockInClockOutLibrary';
...
export default class {
    ...
    static getCurrentTimeStamp(context) {
        let myDate = new Date(); // Assume current UTC timestamp
        const odataDate = new ODataDate(myDate, false);  //new ODataDate();
